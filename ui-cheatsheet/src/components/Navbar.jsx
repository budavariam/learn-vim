  ...
  return (
    <header ref={menuRef} className="sticky top-0 z-40 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
      <div className="max-w-7xl mx-auto px-3 h-12 flex items-center justify-between">
        ...
        <a
          href="#"
          className="font-bold text-gray-800 dark:text-white text-sm tracking-tight hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
        >
          Vim Cheat Sheet
        </a>
        ...
        <nav className="hidden sm:flex items-center gap-1" aria-label="Main navigation">
          ...
          <a
            href="/vimtutor"
            className="px-2.5 py-1 rounded-lg text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
          >
            Vimtutor
          </a>
          ...
          <a
            href="/learn-vim/game"
            className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white shadow-sm transition-all"
          >
            Quiz
          </a>
